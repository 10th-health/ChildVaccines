...
const vaccinationCentersData = {
    "مركز طبي أول": {
        "0-9": ["الأحد", "الاثنين", "الثلاثاء", "الأربعاء"],
        "12-18": ["السبت", "الاثنين", "الأربعاء"],
        "TB": ["السبت", "الثلاثاء"],
        "location": "https://maps.app.goo.gl/gbWNY8Y1vnFjLmFe9?g_st=ac"
    },
    "مركز طبي 40": {
        "0-9": ["الاثنين", "الثلاثاء", "الخميس"],
        "12-18": ["الاثنين", "الخميس"],
        "TB": ["الثلاثاء"],
