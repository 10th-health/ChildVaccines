...
function search() {
    ...
    // Add smooth scroll for search results
    window.scrollBy({
        top: 800,
        behavior: 'smooth'
    });
...
function calculateAge() {
    ...
    // تحويل التواريخ إلى UTC لتجنب مشاكل التوقيت المحلي
    ...
    totalDays = totalDays % 365.25;

    // حساب الشهور
    months = Math.floor(totalDays / 30.4375);
    totalDays = Math.floor(totalDays % 30.4375);

    // الأيام المتبقية
    days = Math.floor(totalDays);

    // حساب إجمالي الشهور لجدول التطعيمات
